...
<!--                    <textarea class="form-control" type="textarea" id="message" name="message" placeholder="How can we help you?" maxlength="140" rows="7" required></textarea>-->
        ...
        <br style="clear:both">     
            ...
            <address><span class="glyphicons glyphicons-group-chat"></span>PES University, Bangalore 560085</address>
            <p><i class="glyphicon glyphicon-envelope"></i> Email:-choudhary.harsh6@gmail.com</p>
            <p><i class="fa fa-facebook-square" aria-hidden="true"></i> facebook:- https://www.facebook.com/choudharyharsh6</p>
            <p><span class="glyphicon glyphicon-phone"></span> Mobile:- +91 8252659801 / +91 8296867951</p>
            <p><i class="fa fa-whatsapp" aria-hidden="true"> WhatsApp:- +91 8252659801</i></p>
            </form>
        </div>
    </div>
